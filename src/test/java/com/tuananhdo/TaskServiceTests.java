...
public class TaskServiceTests {
    ...
    public void testGetTasks() {
        ...
        Mockito.when(tasks).thenReturn(
                Stream.of(new Task(1, "Fix Authentication Duck App", "Change Duck App to Bird App", TaskStatus.NEW, project, user)).collect(Collectors.toList()));
    ...
    @Test
    public void testSaveTask() throws TaskNotFoundException {
        Integer projectId = 9;
        Integer userId = 1;
        Project project = new Project(projectId);
        User user = new User(userId);
        Task task = new Task(30, "Update Bird App ", "This is Bird App !!", TaskStatus.NEW, project, user);
